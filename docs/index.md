...
<img src="/ai-academy-101-rag/assets/img/steps/2a9d7c6b-1260-4ad1-8889-ce01057d2b44.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
<img src="/ai-academy-101-rag/assets/img/steps/9bb475e4-7fef-46d9-9147-a28e806b4e1c.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
<img src="/ai-academy-101-rag/assets/img/steps/22d2c66b-fd1e-4967-9f6c-ae02e27b2036.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
<img src="/ai-academy-101-rag/assets/img/steps/4f493506-970d-4b1d-aee2-1b0972a365d7.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
<img src="/ai-academy-101-rag/assets/img/steps/ed8833ee-5edc-4d28-8b45-2d6ae75e2bf6.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
<img src="/ai-academy-101-rag/assets/img/steps/015d2e96-978f-4606-beac-e25f03253585.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
<img src="/ai-academy-101-rag/assets/img/steps/6b927de3-d54d-43b0-8fb1-7c0998827714.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />

<img src="/ai-academy-101-rag/assets/img/steps/25ec1fb6-d999-41e4-ac17-0c16b14a946d.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
<img src="/ai-academy-101-rag/assets/img/steps/c089a26e-8b31-466b-a052-a05d73d488fb.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
<img src="/ai-academy-101-rag/assets/img/steps/777cdd6e-fa8f-49c2-9398-f94ac45be711.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
<img src="/ai-academy-101-rag/assets/img/steps/daf3df9d-8c77-42b8-9b84-6728ef4a3332.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
2. Once you've created the folder, go ahead and jump into it.
  ...
  <img src="/ai-academy-101-rag/assets/img/steps/8ea84df0-ac9a-4cad-be91-bfb24548d1d1.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
3. Sets up a new project using the Azure GPT-RAG template: `azd init -t azure/gpt-rag`
  ...
  <img src="/ai-academy-101-rag/assets/img/steps/094a0830-2a33-42ae-821c-b8ae199fd772.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />

4. Logs you into Azure Developer CLI: `azd auth login`.

> Ensure your admin account is correctly configured with Authenticator.

<img src="/ai-academy-101-rag/assets/img/steps/f34a13eb-b045-40c9-8f99-edc4dc9d0d15.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />

5. Logs you into your Azure account: `az login`

  <img src="/ai-academy-101-rag/assets/img/steps/bfe9d038-4503-447e-b251-8da67bc0258a.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
6. Updates your environment settings with the latest configuration: `azd env refresh`
      ...
      ```powershell
        ...
        ? Select an Azure Subscription to use:  1. ME-timnab-1 (8237827342e0-9348)
          (OK) Done: Retrieving Azure deployment (gptbrowntest-1745337566)
          (OK) Done: Updated 63 environment variables
    ...
    <img src="/ai-academy-101-rag/assets/img/steps/4c3337e0-514c-4ad5-8324-e911d9542496.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
...
9. Deploys your project to Azure: `azd deploy`
  ...
  <img src="/ai-academy-101-rag/assets/img/steps/aa248d9b-b1eb-42e3-9e6c-5e41bfdf5484.png" alt="Visual reference" style="border: 1px solid #D0D7DE; border-radius: 6px;" />
