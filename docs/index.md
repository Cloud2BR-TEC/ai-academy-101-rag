...
![Visual reference](https://github.com/user-attachments/assets/2a9d7c6b-1260-4ad1-8889-ce01057d2b44)
...
![Visual reference](https://github.com/user-attachments/assets/9bb475e4-7fef-46d9-9147-a28e806b4e1c)
...
![Visual reference](https://github.com/user-attachments/assets/22d2c66b-fd1e-4967-9f6c-ae02e27b2036)
...
![Visual reference](https://github.com/user-attachments/assets/4f493506-970d-4b1d-aee2-1b0972a365d7)
...
![Visual reference](https://github.com/user-attachments/assets/ed8833ee-5edc-4d28-8b45-2d6ae75e2bf6)
...
![Visual reference](https://github.com/user-attachments/assets/015d2e96-978f-4606-beac-e25f03253585)
...
2. Log into the VM using the username and authenticate with the `password stored in the keyvault`, as illustrated in the figure below.
  ...
  ![Visual reference](https://github.com/user-attachments/assets/6b927de3-d54d-43b0-8fb1-7c0998827714)

  ![Visual reference](https://github.com/user-attachments/assets/25ec1fb6-d999-41e4-ac17-0c16b14a946d)
...
![Visual reference](https://github.com/user-attachments/assets/c089a26e-8b31-466b-a052-a05d73d488fb)
...
> Launch the `Command Prompt` and enter the following command to update azd to its latest version:
  ...
  ![Visual reference](https://github.com/user-attachments/assets/777cdd6e-fa8f-49c2-9398-f94ac45be711)
...
> - Configure Server Authentication for Client: This setting controls how the client (your local computer) handles authentication when connecting to the Remote Desktop Session Host server. It ensures that the client verifies the server's identity before establishing a connection. `It provides users with confidence that their remote desktop session is secure and that they are connecting to the correct server.`
  ...
  ![Visual reference](https://github.com/user-attachments/assets/daf3df9d-8c77-42b8-9b84-6728ef4a3332)
...
2. Once you've created the folder, go ahead and jump into it.
    ...
    ![Visual reference](https://github.com/user-attachments/assets/8ea84df0-ac9a-4cad-be91-bfb24548d1d1)
...
3. Sets up a new project using the Azure GPT-RAG template: `azd init -t azure/gpt-rag`
    ...
    ![Visual reference](https://github.com/user-attachments/assets/094a0830-2a33-42ae-821c-b8ae199fd772)

4. Logs you into Azure Developer CLI: `azd auth login`.

> Ensure your admin account is correctly configured with Authenticator.

  ![Visual reference](https://github.com/user-attachments/assets/f34a13eb-b045-40c9-8f99-edc4dc9d0d15)

5. Logs you into your Azure account: `az login`

    ![Visual reference](https://github.com/user-attachments/assets/bfe9d038-4503-447e-b251-8da67bc0258a)
...
6. Updates your environment settings with the latest configuration: `azd env refresh`
      ...
      ![Visual reference](https://github.com/user-attachments/assets/4c3337e0-514c-4ad5-8324-e911d9542496)
...
9. Deploys your project to Azure: `azd deploy`
    ...
    ![Visual reference](https://github.com/user-attachments/assets/aa248d9b-b1eb-42e3-9e6c-5e41bfdf5484)
